...
//  Tomada de decisões -> programa-escola.js
//  Laço -> programa-contador.js
...
- Se o valor de parcelas for inválido, então são 5.
*/

/*
EXERCICIO 2
Você trabalha em uma empresa que constrói escadas no console do navegador. Seu programa deve perguntar o tamanho da escada e construir a escada usando o console.

Exemplo de escada de tamanho 5:
#
##
###
####
...
Bônus: Perguntar também o formato (caracter) do degrau.

Exemplo de escada de tamanho 3 com degrau "!":
!
!!
!!!
*/